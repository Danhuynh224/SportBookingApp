...
public class BookInforPayAdapter extends RecyclerView.Adapter<BookInforPayAdapter.BookInforViewHolder> {
    private final List<BookingInfo> bookingInfos;

    public BookInforPayAdapter(List<BookingInfo> bookingInfos) {
        this.bookingInfos = bookingInfos;
    }

    @NonNull
    @Override
    public BookInforPayAdapter.BookInforViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.inforbookpay
                , parent, false);
        return new BookInforPayAdapter.BookInforViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BookInforPayAdapter.BookInforViewHolder holder, int position) {
